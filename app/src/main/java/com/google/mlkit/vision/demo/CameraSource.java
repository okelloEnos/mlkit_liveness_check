...
public class CameraSource {
  ...
  public void takePicture(Camera.ShutterCallback shutter, Camera.PictureCallback jpeg) {
    if (camera != null) {
  ...
  private class PictureStartCallback implements Camera.ShutterCallback {
    private Camera.ShutterCallback mDelegate;
  ...
  private class PictureDoneCallback implements Camera.PictureCallback {
    private Camera.PictureCallback mDelegate;
